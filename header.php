...
<?php
if (is_page('contact')) { ?>
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/contactNosidebar.css" /
<?php } ?>
<!-- End Styles -->
...
<li class="faq"><a href="https://www.phagens.com/web210/faq/">FAQ</a></li>     
</ul>  
</div>  
 <!-- right bottom--> 
<div class="donate">
